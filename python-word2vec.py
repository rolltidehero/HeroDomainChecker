...
def generate_domains(topic, count, tlds):
    ...
    for word, similarity in words:
        ...
        if len(word) > 3 and word not in domains:
            ...
            domains.append(word + 'security')
            domains.append(word + '-hack')
            domains.append(word + '-hacks')
            domains.append(word + '-hacker')
            domains.append(word + '-hackers')
            domains.append(word + '-hacked')
            domains.append(word + '-hacking')
            domains.append(word + '-protect')
            domains.append(word + '-defend')
            domains.append(word + '-protector')
            domains.append(word + '-defender')
            domains.append(word + '-protection')
            domains.append(word + '-defense')
            domains.append(word + 'hack')
            domains.append(word + 'hacks')
            domains.append(word + 'hacker')
            domains.append(word + 'hackers')
